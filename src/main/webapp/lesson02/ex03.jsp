...
<body>
	...
	<form method="post" action="/lesson02/ex03_1.jsp">
		...
		1. 별명은 무엇입니까?
		<input type="text" name="nickname" placeholder="별명을 입력하세요"><br><br>
		2. 취미는 무엇입니까?
		<input type="text" name="hobby" placeholder="추ㅣ미를 입력하세요"><br><br>
		3. 강아지 or 고양이?
		...
		<label for="mintcho">민트 초코</label>
		<input type="checkbox" id="mintcho" name="food" value="민트">
		<label for="pizza">피자</label>
		<input type="checkbox" id="pizza" name="food" value="피자">
